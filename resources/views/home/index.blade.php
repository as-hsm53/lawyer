										...
										<div class="slide_description_wrapper">
											<div class="slide_description">
												<div class="intro-layer" data-animation="fadeInUp">
													<h3>
														The International Law Firm for Business
													</h3>
			...
			<section id="about" class="ls ms section_padding_0 columns_padding_0 section_about">
				<div class="container-fluid">
					<div class="row">
						...
						<div class="col-md-6 section_padding_top_60 section_padding_bottom_65 to_animate" data-animation="fadeInLeft">
							...
							<div class="container-left-half">
								<div class="row">
									<div class="col-xs-12">
										...
										<h2 class="section_header highlight">Welcome to The Justice</h2>
										<p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered.</p>
										<p>
											If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything embarrassing hidden in the middle of text. All the Lorem Ipsum generators on the Internet tend to repeat predefined chunks as necessary, making this the first true
											generator on the Internet.
										</p>
										<div class="topmargin_60 content-justify vertical-center">
											<div>
												<p class="small-text grey margin_0">paul small</p>
						...
						<!-- .col-* -->
						<div class="col-md-6 to_animate hidden-sm hidden-xs" data-animation="fadeInRight">
			...
			<section id="services" class="ds section_padding_50 section_services parallax">
				<div class="container">
					...
					<div class="row columns_padding_25 columns_margin_bottom_60 topmargin_30">
						<div class="col-md-4 col-sm-6 to_animate" data-animation="pullDown">
							<div class="teaser media">
								...
								<div class="media-body toppadding_5">
									<h3 class="muli">
										<a href="service-single.html">Criminal Law</a>
									</h3>
									<hr class="divider_30_3 divider_left divider_10 main_bg_color">
									<p>Ball tip boudin chicken, cetta bresaola doner prosciutto meatloaf leberkas cow.</p>
								</div>
							</div>
						</div>
						<div class="col-md-4 col-sm-6 to_animate" data-animation="pullDown">
						...
						<div class="col-md-4 col-sm-6 clear-sm to_animate" data-animation="pullDown">
							<div class="teaser media">
								<div class="media-left">
									<div class="teaser_icon highlight size_normal">
						...
						<div class="col-md-4 col-sm-6 clear-lg clear-md to_animate" data-animation="pullDown">
							<div class="teaser media">
								<div class="media-left">
									<div class="teaser_icon highlight size_normal">
								...
								<div class="media-body toppadding_5">
									<h3 class="muli">
										<a href="service-single.html">Family Law</a>
									</h3>
									<hr class="divider_30_3 divider_left divider_10 main_bg_color">
						...
						<div class="col-md-4 col-sm-6 clear-sm to_animate" data-animation="pullDown">
							<div class="teaser media">
								...
								<div class="media-body toppadding_5">
									<h3 class="muli">
										<a href="service-single.html">Personal Law</a>
									</h3>
									<hr class="divider_30_3 divider_left divider_10 main_bg_color">
									<p>Pig doner ball tip shoulder, turkey short ribs boudin picola tri-tip biltong.</p>
								</div>
							</div>
						</div>
						<div class="col-md-4 col-sm-6 to_animate" data-animation="pullDown">
							<div class="teaser media">
								<div class="media-left">
									<div class="teaser_icon highlight size_normal">
										<i class="icon-bracelets"></i>
									</div>
								</div>
								<div class="media-body toppadding_5">
									<h3 class="muli">
										<a href="service-single.html">Drug Offence</a>
									</h3>
									<hr class="divider_30_3 divider_left divider_10 main_bg_color">
									<p>Brisket saHamburger meatball rump, sirloin spare ribs strip steak andouille tail picanha.</p>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="container">
					<div class="row">
						<div class="col-sm-12 text-center">
							...
							<p>Laborum veniam aute eu salami prosciutto qui, bacon capicola cillum. Ribeye proident sed cow boudin.</p>
							<p>
			...
			<section id="consultation" class="ds section_padding_0 section_about">
				<div class="container-fluid">
					<div class="row row_columns_padding_0">
						...
						<div class="col-md-6 col-md-push-6 section_padding_top_60 section_padding_bottom_65 to_animate" data-animation="fadeInRight">
							<div class="container-right-half">
								<div class="row">
						...
						<div class="col-md-6 col-md-pull-6 text-center text-md-right to_animate" data-animation="fadeInLeft">
